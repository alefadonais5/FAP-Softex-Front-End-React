...
// const numero3: = Number(prompt("Digite o número inteiro: "));
// if (numero3 !== null && Number.isInteger(Number(numero3))){
//     const numeroConvertido = parseFloat(numero3);
//     alert("Número convertido para decimal: " + numeroConvertido);
// }else{
...
// let input: String | null = prompt("Digite os números separados por espaço:");
// if ( input !== null){
//     let numberArray = input.split(" ").map(Number);
//     alert("Você digitou " + numberArray.length + " números.");
// }else{
// }
...
var height = Number(prompt("Digite a altura: "));
var weight = Number(prompt("Digite o peso: "));
var imc = weight / (height * height);
alert("O imc \u00E9 ".concat(imc));
